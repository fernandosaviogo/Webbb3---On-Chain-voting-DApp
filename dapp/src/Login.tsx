    ...
    return (
        <div className="bg-web3">
            <div className="container">
                <div className="web3-card row flex-lg-row-reverse align-items-center g-5">
                    ...
                    <div className="col-12 col-lg-6">
                        <h1 className="web3-title lh-1 mb-3">
                            Webbb3
                        </h1>
                        <p className="lead">
                        ...
                        {!isConnected && (
                            <>
                                <button
                                    type="button"
                                    className="btn web3-btn btn-lg w-100 d-flex justify-content-center align-items-center gap-3"
