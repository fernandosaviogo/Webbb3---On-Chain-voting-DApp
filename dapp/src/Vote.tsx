    ...
    return (
        <div className='container px-4 py-5'>
            <div className='row align-items-center'>
                <h1 className='display-5 fe-bold text-body-emohasis lh-1 mb-3'>Webbb3</h1>
                <p className='lead'>Votação on-chain do BBB.</p>
                {
                    isExpired()
                        ? <p className='lead mb-3'>Votação encerrada. Confira abaixo os resultados.</p>
                        : <p className='lead mb-3'>Você tem até {getMaxDate()} para deixar seu voto em um dos participantes para que ele saida do programa.</p>
                }
            </div>
